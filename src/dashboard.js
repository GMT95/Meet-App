...
<Form.Field>
  ...
  <input placeholder='Nick Name' onChange={(e) => this.setState({nickname: e.target.value})}/>
</Form.Field>
<Form.Field>
  <label>Phone Number</label>
  <input placeholder='Phone Number' type="number" onChange={(e) => this.setState({phoneNumber: e.target.value})}/>
</Form.Field>
<Link to="/imageupload">
<Button type='submit' onClick={this.sendToDb}>Next</Button>
</Link>
</Form> 
        </Grid.Column>
    </Grid.Row>
